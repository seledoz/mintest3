...
window.__minibiaBotBundle.installPanel = function installPanel(bot) {
  ...
  function inject() {
    ...
    document.body.appendChild(panel); ensureAllModuleCollapseControls(panel); applySavedPanelPosition(panel); setPanelCollapsed(panel, getSavedPanelCollapsed()); enableDrag(panel);
